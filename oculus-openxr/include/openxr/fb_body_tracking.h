...
#if defined(XR_FB_body_tracking_EXPERIMENTAL_VERSION) && (XR_FB_body_tracking_EXPERIMENTAL_VERSION == 2)
typedef XrResult(XRAPI_PTR* PFN_xrGetSkeletonFB)(XrBodyTrackerFB bodyTracker, XrBodySkeletonFB* skeleton);
#endif
...
XRAPI_ATTR XrResult XRAPI_CALL xrCreateBodyTrackerV1FB(XrSession                        session,
													   const XrBodyTrackerCreateInfoFB* createInfo,
													   XrBodyTrackerFB* bodyTracker);
...
XRAPI_ATTR XrResult XRAPI_CALL xrLocateBodyJointsV1FB(XrBodyTrackerFB                 bodyTracker,
													  const XrBodyJointsLocateInfoFB* locateInfo,
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetSkeletonFB(XrBodyTrackerFB bodyTracker, XrBodySkeletonFB* skeleton);
