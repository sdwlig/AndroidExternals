...
typedef XrResult(XRAPI_PTR* PFN_xrGetDevicePCMSampleRateFBX1)(XrSession session,
															  XrDevicePcmSampleRateGetInfoFB* deviceSampleRate);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetDevicePCMSampleRateFB(XrSession                       session,
														  XrDevicePcmSampleRateGetInfoFB* deviceSampleRate);
