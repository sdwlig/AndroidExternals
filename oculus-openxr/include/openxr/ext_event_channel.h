 ...
 */
XRAPI_ATTR XrResult XRAPI_CALL xrCreateEventChannelEXT(XrInstance                         instance,
...
*/
XRAPI_ATTR XrResult XRAPI_CALL xrPollEventChannelEXT(XrEventChannelEXT channel, XrEventDataBuffer* eventData);
...
*/
XRAPI_ATTR XrResult XRAPI_CALL xrSelectEventChannelEXT(XrInstance instance, XrSelectEventChannelInfoEXT* info,
													   uint32_t* channelWithEvent);

/*
set default eventchannel handle and used by application
*/
XRAPI_ATTR XrResult XRAPI_CALL xrSetDefaultEventChannelEXT(XrInstance instance, XrEventChannelEXT channel);

#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */

typedef XrResult(XRAPI_PTR* PFN_xrCreateEventChannelEXT)(XrInstance instance,
														 const XrEventChannelCreateInfoEXT* info,
														 XrEventChannelEXT* channel);

typedef XrResult(XRAPI_PTR* PFN_xrDestroyEventChannelEXT)(XrEventChannelEXT channel);

typedef XrResult(XRAPI_PTR* PFN_xrPollEventChannelEXT)(XrEventChannelEXT channel, XrEventDataBuffer* eventData);

typedef XrResult(XRAPI_PTR* PFN_xrSelectEventChannelEXT)(XrInstance instance, XrSelectEventChannelInfoEXT* info,
														 uint32_t* channelWithEvent);

typedef XrResult(XRAPI_PTR* PFN_xrSetDefaultEventChannelEXT)(XrInstance instance, XrEventChannelEXT channel);
