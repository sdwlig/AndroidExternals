...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpaceUserFB)(XrSession session, const XrSpaceUserCreateInfoFB* info,
													 XrSpaceUserFB* user);

typedef XrResult(XRAPI_PTR* PFN_xrGetSpaceUserIdFB)(const XrSpaceUserFB user, XrSpaceUserIdFB* userId);
...
XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpaceUserFB(XrSession session, const XrSpaceUserCreateInfoFB* info,
												   XrSpaceUserFB* user);

// xrGetSpaceUserIdFB retrieves the userId corresponding to the given XrSpaceUserFB handle.
XRAPI_ATTR XrResult XRAPI_CALL xrGetSpaceUserIdFB(const XrSpaceUserFB user, XrSpaceUserIdFB* userId);
