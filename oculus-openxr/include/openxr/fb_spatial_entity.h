...
static const XrStructureType XR_TYPE_SYSTEM_SPATIAL_ENTITY_PROPERTIES_FB = (XrStructureType)1000113004;
...
static const XrStructureType XR_TYPE_SPACE_COMPONENT_STATUS_SET_INFO_FB = (XrStructureType)1000113007;
...
static const XrStructureType XR_TYPE_EVENT_DATA_SPATIAL_ANCHOR_CREATE_COMPLETE_FB = (XrStructureType)1000113005;
...
// is cleared.
static const XrStructureType XR_TYPE_EVENT_DATA_SPACE_SET_STATUS_COMPLETE_FB = (XrStructureType)1000113006;
...
static const XrStructureType XR_TYPE_EVENT_DATA_SET_COMPONENT_ENABLE_RESULT_FBX2 = (XrStructureType)1000113002;
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialAnchorFBX2)(XrSession session,
														   const XrSpatialAnchorCreateInfoFB* info,
														   XrSpace* space);

typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialEntityUuidFBX2)(XrSpace space, XrSpatialEntityUuidFBX2* uuid);

typedef XrResult(XRAPI_PTR* PFN_xrEnumerateSupportedComponentsFBX2)(XrSpace space, uint32_t componentTypeCapacityInput,
																	uint32_t* componentTypeCountOutput,
																	XrSpaceComponentTypeFB* componentTypes);

typedef XrResult(XRAPI_PTR* PFN_xrSetComponentEnabledFBX2)(XrSpace space,
														   const XrComponentEnableRequestFBX2* info,
														   XrAsyncRequestIdFB* requestId);

typedef XrResult(XRAPI_PTR* PFN_xrGetComponentStatusFBX2)(XrSpace space, XrSpaceComponentTypeFB componentType,
														  XrSpaceComponentStatusFB* status);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialEntityUuidFB(XrSpace space, XrSpatialEntityUuidFBX2* uuid);

XRAPI_ATTR XrResult XRAPI_CALL xrEnumerateSupportedComponentsFB(XrSpace space, uint32_t componentTypeCapacityInput,
																uint32_t* componentTypeCountOutput,
																XrSpaceComponentTypeFB* componentTypes);

XRAPI_ATTR XrResult XRAPI_CALL xrSetComponentEnabledFB(XrSpace space, const XrComponentEnableRequestFBX2* info,
													   XrAsyncRequestIdFB* requestId);

XRAPI_ATTR XrResult XRAPI_CALL xrGetComponentStatusFB(XrSpace space, XrSpaceComponentTypeFB componentType,
													  XrSpaceComponentStatusFB* status);
