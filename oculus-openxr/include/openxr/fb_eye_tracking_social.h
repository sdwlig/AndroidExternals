...
#if defined(XR_FB_eye_tracking_EXPERIMENTAL_VERSION) && defined(XR_FB_eye_tracking_social_EXPERIMENTAL_VERSION)
#error "either XR_FB_eye_tracking_EXPERIMENTAL_VERSION or XR_FB_eye_tracking_social_EXPERIMENTAL_VERSION should be defined"
#endif
#if defined(XR_FB_eye_tracking_EXPERIMENTAL_VERSION) && (XR_FB_eye_tracking_EXPERIMENTAL_VERSION != 1)
...
#elif defined(XR_FB_eye_tracking_EXPERIMENTAL_VERSION) && (XR_FB_eye_tracking_EXPERIMENTAL_VERSION == 1)
...
XRAPI_ATTR XrResult XRAPI_CALL xrCreateEyeTrackerV1FB(XrSession                         session,
													  const XrEyeTrackerCreateInfoV1FB* createInfo,
													  XrEyeTrackerFB*                   eyeTracker);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateEyeTrackerV2FB(XrSession                         session,
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetEyeGazesV1FB(XrEyeTrackerFB eyeTracker, const XrEyeGazesInfoFB* gazeInfo,
												 XrEyeGazesV1FB* eyeGazes);

XRAPI_ATTR XrResult XRAPI_CALL xrGetEyeGazesV2FB(XrEyeTrackerFB eyeTracker, const XrEyeGazesInfoFB* gazeInfo,
												 XrEyeGazesV2FB* eyeGazes);

#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */

#if !defined(XR_FB_eye_tracking_social_EXPERIMENTAL_VERSION) && !defined(XR_FB_eye_tracking_EXPERIMENTAL_VERSION) \
