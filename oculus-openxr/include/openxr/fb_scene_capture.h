...
// Events.
static const XrStructureType XR_TYPE_EVENT_DATA_SCENE_CAPTURE_COMPLETE_FB = (XrStructureType)1000198001;
...
// Request scene capture to the system.
XRAPI_ATTR XrResult XRAPI_CALL xrRequestSceneCaptureFB(XrSession                          session,
													   const XrSceneCaptureRequestInfoFB* request,
													   XrAsyncRequestIdFB* requestId);
