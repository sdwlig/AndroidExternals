...
#if !defined(XR_FB_face_tracking_EXPERIMENTAL_VERSION) || (XR_FB_face_tracking_EXPERIMENTAL_VERSION == 2)
...
#if defined(XR_FB_face_tracking_EXPERIMENTAL_VERSION) && (XR_FB_face_tracking_EXPERIMENTAL_VERSION == 1)
...
XRAPI_ATTR XrResult XRAPI_CALL xrCreateFaceTrackerV2FB(XrSession                          session,
													   const XrFaceTrackerCreateInfoV2FB* createInfo,
													   XrFaceTrackerFB* faceTracker);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateFaceTrackerV1FB(XrSession                          session,
													   const XrFaceTrackerCreateInfoV1FB* createInfo,
													   XrFaceTrackerFB* faceTracker);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroyFaceTrackerFB(XrFaceTrackerFB faceTracker);

XRAPI_ATTR XrResult XRAPI_CALL xrGetFaceExpressionWeightsV2FB(XrFaceTrackerFB faceTracker,
															  const XrFaceExpressionInfoFB* expressionInfo,
															  XrFaceExpressionWeightsV2FB* expressionWeights);

XRAPI_ATTR XrResult XRAPI_CALL xrGetFaceExpressionWeightsV1FB(XrFaceTrackerFB faceTracker,
															  const XrFaceExpressionInfoFB* expressionInfo,
															  XrFaceExpressionWeightsV1FB* expressionWeights);
