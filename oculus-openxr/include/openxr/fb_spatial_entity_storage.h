...
// calling function
static const XrStructureType XR_TYPE_EVENT_DATA_SPACE_SAVE_COMPLETE_FB = (XrStructureType)1000158106;
...
// calling function
static const XrStructureType XR_TYPE_EVENT_DATA_SPACE_ERASE_COMPLETE_FB = (XrStructureType)1000158107;
...
static const XrStructureType XR_TYPE_EVENT_SPATIAL_ENTITY_STORAGE_SAVE_RESULT_FBX2 = (XrStructureType)1000077103;
...
static const XrStructureType XR_TYPE_EVENT_SPATIAL_ENTITY_STORAGE_ERASE_RESULT_FBX2 = (XrStructureType)1000077104;
...
typedef XrResult(XRAPI_PTR* PFN_xrSpatialEntitySaveSpaceFBX2)(XrSession session, const XrSpaceSaveInfoFB* info,
															  XrAsyncRequestIdFB* requestId);

typedef XrResult(XRAPI_PTR* PFN_xrSpatialEntityEraseSpaceFBX2)(XrSession session, const XrSpaceEraseInfoFB* info,
															   XrAsyncRequestIdFB* requestId);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES

XRAPI_ATTR XrResult XRAPI_CALL xrSpatialEntitySaveSpaceFB(XrSession session, const XrSpaceSaveInfoFB* info,
														  XrAsyncRequestIdFB* requestId);

XRAPI_ATTR XrResult XRAPI_CALL xrSpatialEntityEraseSpaceFB(XrSession session, const XrSpaceEraseInfoFB* info,
														   XrAsyncRequestIdFB* requestId);
