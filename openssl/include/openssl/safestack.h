...
#define SKM_DEFINE_STACK_OF_INTERNAL(t1, t2, t3)                                                                 \
	...
	static ossl_unused ossl_inline t2* ossl_check_##t1##_type(t2* ptr) { return ptr; }                           \
...
#define SKM_DEFINE_STACK_OF(t1, t2, t3)                                                                          \
	...
	{                                                                                                            \
		return (STACK_OF(t1)*)OPENSSL_sk_deep_copy((const OPENSSL_STACK*)sk, (OPENSSL_sk_copyfunc)copyfunc,      \
												   (OPENSSL_sk_freefunc)freefunc);                               \
	}                                                                                                            \
	static ossl_unused ossl_inline sk_##t1##_compfunc sk_##t1##_set_cmp_func(STACK_OF(t1) * sk,                  \
																			 sk_##t1##_compfunc compare)         \
	{                                                                                                            \
...
#define sk_OPENSSL_STRING_value(sk, idx) \
	((char*)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(sk), (idx)))
#define sk_OPENSSL_STRING_new(cmp) \
	((STACK_OF(OPENSSL_STRING)*)OPENSSL_sk_new(ossl_check_OPENSSL_STRING_compfunc_type(cmp)))
#define sk_OPENSSL_STRING_new_null() ((STACK_OF(OPENSSL_STRING)*)OPENSSL_sk_new_null())
#define sk_OPENSSL_STRING_new_reserve(cmp, n) \
	((STACK_OF(OPENSSL_STRING)*)OPENSSL_sk_new_reserve(ossl_check_OPENSSL_STRING_compfunc_type(cmp), (n)))
#define sk_OPENSSL_STRING_reserve(sk, n) \
...
#define sk_OPENSSL_STRING_delete(sk, i) \
	((char*)OPENSSL_sk_delete(ossl_check_OPENSSL_STRING_sk_type(sk), (i)))
#define sk_OPENSSL_STRING_delete_ptr(sk, ptr) \
	((char*)OPENSSL_sk_delete_ptr(ossl_check_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_type(ptr)))
#define sk_OPENSSL_STRING_push(sk, ptr) \
	OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_type(ptr))
#define sk_OPENSSL_STRING_unshift(sk, ptr) \
...
#define sk_OPENSSL_STRING_dup(sk) \
	((STACK_OF(OPENSSL_STRING)*)OPENSSL_sk_dup(ossl_check_const_OPENSSL_STRING_sk_type(sk)))
#define sk_OPENSSL_STRING_deep_copy(sk, copyfunc, freefunc)                                             \
	((STACK_OF(OPENSSL_STRING)*)OPENSSL_sk_deep_copy(ossl_check_const_OPENSSL_STRING_sk_type(sk),       \
													 ossl_check_OPENSSL_STRING_copyfunc_type(copyfunc), \
													 ossl_check_OPENSSL_STRING_freefunc_type(freefunc)))
#define sk_OPENSSL_STRING_set_cmp_func(sk, cmp)                                                 \
	((sk_OPENSSL_STRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OPENSSL_STRING_sk_type(sk), \
														 ossl_check_OPENSSL_STRING_compfunc_type(cmp)))
...
#define sk_OPENSSL_CSTRING_value(sk, idx) \
	((const char*)OPENSSL_sk_value(ossl_check_const_OPENSSL_CSTRING_sk_type(sk), (idx)))
#define sk_OPENSSL_CSTRING_new(cmp) \
	((STACK_OF(OPENSSL_CSTRING)*)OPENSSL_sk_new(ossl_check_OPENSSL_CSTRING_compfunc_type(cmp)))
...
#define sk_OPENSSL_CSTRING_new_reserve(cmp, n) \
	((STACK_OF(OPENSSL_CSTRING)*)OPENSSL_sk_new_reserve(ossl_check_OPENSSL_CSTRING_compfunc_type(cmp), (n)))
#define sk_OPENSSL_CSTRING_reserve(sk, n) \
...
#define sk_OPENSSL_CSTRING_delete(sk, i) \
	((const char*)OPENSSL_sk_delete(ossl_check_OPENSSL_CSTRING_sk_type(sk), (i)))
#define sk_OPENSSL_CSTRING_delete_ptr(sk, ptr)                                  \
	((const char*)OPENSSL_sk_delete_ptr(ossl_check_OPENSSL_CSTRING_sk_type(sk), \
										ossl_check_OPENSSL_CSTRING_type(ptr)))
#define sk_OPENSSL_CSTRING_push(sk, ptr) \
	OPENSSL_sk_push(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_type(ptr))
#define sk_OPENSSL_CSTRING_unshift(sk, ptr) \
	OPENSSL_sk_unshift(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_type(ptr))
#define sk_OPENSSL_CSTRING_pop(sk) \
	((const char*)OPENSSL_sk_pop(ossl_check_OPENSSL_CSTRING_sk_type(sk)))
#define sk_OPENSSL_CSTRING_shift(sk) \
	((const char*)OPENSSL_sk_shift(ossl_check_OPENSSL_CSTRING_sk_type(sk)))
#define sk_OPENSSL_CSTRING_pop_free(sk, freefunc)               \
	OPENSSL_sk_pop_free(ossl_check_OPENSSL_CSTRING_sk_type(sk), \
						ossl_check_OPENSSL_CSTRING_freefunc_type(freefunc))
#define sk_OPENSSL_CSTRING_insert(sk, ptr, idx) \
	OPENSSL_sk_insert(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_type(ptr), (idx))
#define sk_OPENSSL_CSTRING_set(sk, idx, ptr)                                    \
	((const char*)OPENSSL_sk_set(ossl_check_OPENSSL_CSTRING_sk_type(sk), (idx), \
								 ossl_check_OPENSSL_CSTRING_type(ptr)))
#define sk_OPENSSL_CSTRING_find(sk, ptr) \
	OPENSSL_sk_find(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_type(ptr))
#define sk_OPENSSL_CSTRING_find_ex(sk, ptr) \
	OPENSSL_sk_find_ex(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_type(ptr))
#define sk_OPENSSL_CSTRING_find_all(sk, ptr, pnum) \
...
#define sk_OPENSSL_CSTRING_is_sorted(sk) \
	OPENSSL_sk_is_sorted(ossl_check_const_OPENSSL_CSTRING_sk_type(sk))
#define sk_OPENSSL_CSTRING_dup(sk) \
	((STACK_OF(OPENSSL_CSTRING)*)OPENSSL_sk_dup(ossl_check_const_OPENSSL_CSTRING_sk_type(sk)))
#define sk_OPENSSL_CSTRING_deep_copy(sk, copyfunc, freefunc)                                              \
	((STACK_OF(OPENSSL_CSTRING)*)OPENSSL_sk_deep_copy(ossl_check_const_OPENSSL_CSTRING_sk_type(sk),       \
													  ossl_check_OPENSSL_CSTRING_copyfunc_type(copyfunc), \
													  ossl_check_OPENSSL_CSTRING_freefunc_type(freefunc)))
#define sk_OPENSSL_CSTRING_set_cmp_func(sk, cmp)           \
	((sk_OPENSSL_CSTRING_compfunc)OPENSSL_sk_set_cmp_func( \
		ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_compfunc_type(cmp)))
...
#define sk_OPENSSL_BLOCK_value(sk, idx) \
	((void*)OPENSSL_sk_value(ossl_check_const_OPENSSL_BLOCK_sk_type(sk), (idx)))
#define sk_OPENSSL_BLOCK_new(cmp) \
	((STACK_OF(OPENSSL_BLOCK)*)OPENSSL_sk_new(ossl_check_OPENSSL_BLOCK_compfunc_type(cmp)))
#define sk_OPENSSL_BLOCK_new_null() ((STACK_OF(OPENSSL_BLOCK)*)OPENSSL_sk_new_null())
#define sk_OPENSSL_BLOCK_new_reserve(cmp, n) \
	((STACK_OF(OPENSSL_BLOCK)*)OPENSSL_sk_new_reserve(ossl_check_OPENSSL_BLOCK_compfunc_type(cmp), (n)))
#define sk_OPENSSL_BLOCK_reserve(sk, n) \
...
#define sk_OPENSSL_BLOCK_delete(sk, i) \
	((void*)OPENSSL_sk_delete(ossl_check_OPENSSL_BLOCK_sk_type(sk), (i)))
#define sk_OPENSSL_BLOCK_delete_ptr(sk, ptr) \
	((void*)OPENSSL_sk_delete_ptr(ossl_check_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_type(ptr)))
#define sk_OPENSSL_BLOCK_push(sk, ptr) \
	OPENSSL_sk_push(ossl_check_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_type(ptr))
#define sk_OPENSSL_BLOCK_unshift(sk, ptr) \
...
#define sk_OPENSSL_BLOCK_dup(sk) \
	((STACK_OF(OPENSSL_BLOCK)*)OPENSSL_sk_dup(ossl_check_const_OPENSSL_BLOCK_sk_type(sk)))
#define sk_OPENSSL_BLOCK_deep_copy(sk, copyfunc, freefunc)                                            \
	((STACK_OF(OPENSSL_BLOCK)*)OPENSSL_sk_deep_copy(ossl_check_const_OPENSSL_BLOCK_sk_type(sk),       \
													ossl_check_OPENSSL_BLOCK_copyfunc_type(copyfunc), \
													ossl_check_OPENSSL_BLOCK_freefunc_type(freefunc)))
#define sk_OPENSSL_BLOCK_set_cmp_func(sk, cmp)                                                \
	((sk_OPENSSL_BLOCK_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OPENSSL_BLOCK_sk_type(sk), \
														ossl_check_OPENSSL_BLOCK_compfunc_type(cmp)))
