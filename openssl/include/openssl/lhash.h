...
#define DEFINE_LHASH_OF_INTERNAL(type)                                                                                \
	...
	static ossl_unused ossl_inline const OPENSSL_LHASH* ossl_check_const_##type##_lh_type(                            \
		const LHASH_OF(type) * lh)                                                                                    \
	{                                                                                                                 \
	...
	static ossl_unused ossl_inline OPENSSL_LH_DOALL_FUNC ossl_check_##type##_lh_doallfunc_type(                       \
		lh_##type##_doallfunc dfn)                                                                                    \
	{                                                                                                                 \
...
#define DEFINE_LHASH_OF(type)                                                                                  \
	...
	static ossl_unused ossl_inline LHASH_OF(type)                                                              \
		* lh_##type##_new(unsigned long (*hfn)(const type*), int (*cfn)(const type*, const type*))             \
	{                                                                                                          \
...
#define int_implement_lhash_doall(type, argtype, cbargtype)                                 \
	static ossl_unused ossl_inline void lh_##type##_doall_##argtype(                        \
		LHASH_OF(type) * lh, void (*fn)(cbargtype*, argtype*), argtype* arg)                \
	{                                                                                       \
...
#define lh_OPENSSL_STRING_new(hfn, cmp)                                                         \
	((LHASH_OF(OPENSSL_STRING)*)OPENSSL_LH_new(ossl_check_OPENSSL_STRING_lh_hashfunc_type(hfn), \
...
#define lh_OPENSSL_STRING_insert(lh, ptr)                                      \
	((OPENSSL_STRING*)OPENSSL_LH_insert(ossl_check_OPENSSL_STRING_lh_type(lh), \
										ossl_check_OPENSSL_STRING_lh_plain_type(ptr)))
#define lh_OPENSSL_STRING_delete(lh, ptr)                                      \
	((OPENSSL_STRING*)OPENSSL_LH_delete(ossl_check_OPENSSL_STRING_lh_type(lh), \
										ossl_check_const_OPENSSL_STRING_lh_plain_type(ptr)))
#define lh_OPENSSL_STRING_retrieve(lh, ptr)                                      \
	((OPENSSL_STRING*)OPENSSL_LH_retrieve(ossl_check_OPENSSL_STRING_lh_type(lh), \
										  ossl_check_const_OPENSSL_STRING_lh_plain_type(ptr)))
...
#define lh_OPENSSL_STRING_node_stats_bio(lh, out) \
	OPENSSL_LH_node_stats_bio(ossl_check_const_OPENSSL_STRING_lh_type(lh), out)
#define lh_OPENSSL_STRING_node_usage_stats_bio(lh, out) \
	OPENSSL_LH_node_usage_stats_bio(ossl_check_const_OPENSSL_STRING_lh_type(lh), out)
#define lh_OPENSSL_STRING_stats_bio(lh, out) \
	OPENSSL_LH_stats_bio(ossl_check_const_OPENSSL_STRING_lh_type(lh), out)
#define lh_OPENSSL_STRING_get_down_load(lh) \
	OPENSSL_LH_get_down_load(ossl_check_OPENSSL_STRING_lh_type(lh))
#define lh_OPENSSL_STRING_set_down_load(lh, dl) \
	OPENSSL_LH_set_down_load(ossl_check_OPENSSL_STRING_lh_type(lh), dl)
#define lh_OPENSSL_STRING_doall(lh, dfn) \
...
#define lh_OPENSSL_CSTRING_new(hfn, cmp)                                                          \
	((LHASH_OF(OPENSSL_CSTRING)*)OPENSSL_LH_new(ossl_check_OPENSSL_CSTRING_lh_hashfunc_type(hfn), \
...
#define lh_OPENSSL_CSTRING_insert(lh, ptr)                                       \
	((OPENSSL_CSTRING*)OPENSSL_LH_insert(ossl_check_OPENSSL_CSTRING_lh_type(lh), \
										 ossl_check_OPENSSL_CSTRING_lh_plain_type(ptr)))
#define lh_OPENSSL_CSTRING_delete(lh, ptr)                                       \
	((OPENSSL_CSTRING*)OPENSSL_LH_delete(ossl_check_OPENSSL_CSTRING_lh_type(lh), \
										 ossl_check_const_OPENSSL_CSTRING_lh_plain_type(ptr)))
#define lh_OPENSSL_CSTRING_retrieve(lh, ptr)                                       \
	((OPENSSL_CSTRING*)OPENSSL_LH_retrieve(ossl_check_OPENSSL_CSTRING_lh_type(lh), \
										   ossl_check_const_OPENSSL_CSTRING_lh_plain_type(ptr)))
#define lh_OPENSSL_CSTRING_error(lh) OPENSSL_LH_error(ossl_check_OPENSSL_CSTRING_lh_type(lh))
#define lh_OPENSSL_CSTRING_num_items(lh) \
	OPENSSL_LH_num_items(ossl_check_OPENSSL_CSTRING_lh_type(lh))
#define lh_OPENSSL_CSTRING_node_stats_bio(lh, out) \
	OPENSSL_LH_node_stats_bio(ossl_check_const_OPENSSL_CSTRING_lh_type(lh), out)
#define lh_OPENSSL_CSTRING_node_usage_stats_bio(lh, out) \
	OPENSSL_LH_node_usage_stats_bio(ossl_check_const_OPENSSL_CSTRING_lh_type(lh), out)
#define lh_OPENSSL_CSTRING_stats_bio(lh, out) \
	OPENSSL_LH_stats_bio(ossl_check_const_OPENSSL_CSTRING_lh_type(lh), out)
#define lh_OPENSSL_CSTRING_get_down_load(lh) \
	OPENSSL_LH_get_down_load(ossl_check_OPENSSL_CSTRING_lh_type(lh))
#define lh_OPENSSL_CSTRING_set_down_load(lh, dl) \
	OPENSSL_LH_set_down_load(ossl_check_OPENSSL_CSTRING_lh_type(lh), dl)
#define lh_OPENSSL_CSTRING_doall(lh, dfn) \
