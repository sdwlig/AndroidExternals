 ...
 *  \return 1 on success and 0 if an error occurred
 */
OSSL_DEPRECATEDIN_3_0 int EC_GROUP_set_curve_GFp(EC_GROUP* group, const BIGNUM* p, const BIGNUM* a,
 ...
 *  \return 1 on success and 0 if an error occurred
 */
OSSL_DEPRECATEDIN_3_0 int EC_GROUP_set_curve_GF2m(EC_GROUP* group, const BIGNUM* p, const BIGNUM* a,
												  const BIGNUM* b, BN_CTX* ctx);
 ...
 */
size_t EC_POINT_point2oct(const EC_GROUP* group, const EC_POINT* p, point_conversion_form_t form,
 ...
 *  \return 1 on success and 0 if an error occurred
 */
OSSL_DEPRECATEDIN_3_0 int EC_POINTs_mul(const EC_GROUP* group, EC_POINT* r, const BIGNUM* n, size_t num,
 ...
 *  This identifier is retained for backwards compatibility
 */
OSSL_DEPRECATEDIN_3_0 int ECDH_KDF_X9_62(unsigned char* out, size_t outlen, const unsigned char* Z, size_t Zlen,
										 const unsigned char* sinfo, size_t sinfolen, const EVP_MD* md);

OSSL_DEPRECATEDIN_3_0 int ECDH_compute_key(void* out, size_t outlen, const EC_POINT* pub_key, const EC_KEY* ecdh,
...
OSSL_DEPRECATEDIN_3_0 void EC_KEY_METHOD_set_init(EC_KEY_METHOD* meth, int (*init)(EC_KEY* key),
...
OSSL_DEPRECATEDIN_3_0 void EC_KEY_METHOD_set_verify(
	EC_KEY_METHOD* meth,
	int (*verify)(int type, const unsigned char* dgst, int dgst_len, const unsigned char* sigbuf,
				  int sig_len, EC_KEY* eckey),
	int (*verify_sig)(const unsigned char* dgst, int dgst_len, const ECDSA_SIG* sig, EC_KEY* eckey));

OSSL_DEPRECATEDIN_3_0 void
EC_KEY_METHOD_get_init(const EC_KEY_METHOD* meth, int (**pinit)(EC_KEY* key),
					   void (**pfinish)(EC_KEY* key), int (**pcopy)(EC_KEY* dest, const EC_KEY* src),
...
OSSL_DEPRECATEDIN_3_0 void EC_KEY_METHOD_get_compute_key(const EC_KEY_METHOD* meth,
														 int (**pck)(unsigned char** psec, size_t* pseclen,
...
OSSL_DEPRECATEDIN_3_0 void EC_KEY_METHOD_get_verify(
	const EC_KEY_METHOD* meth,
	int (**pverify)(int type, const unsigned char* dgst, int dgst_len, const unsigned char* sigbuf,
					int sig_len, EC_KEY* eckey),
